...
export const GeneralSection: React.FC<{ data: any; sessionId: string }> = ({ data, sessionId }) => (
  <SimpleSection title="General Information" eyebrow="STEP 01" data={data} sessionId={sessionId} />
);

export const DnsSection: React.FC<{ data: any; sessionId: string }> = ({ data, sessionId }) => (
