 ...
 * Run with:  npx tsx --tsconfig api/tsconfig.json api/gen-sample-pdf.tsx
 * Output:    sample-onboarding.pdf  (in project root)
 */
  ...
  rooms: [
    {
      ...
      imageUrls: ['https://www.grandpavilion.dk/rooms/deluxe-1.jpg', 'https://www.grandpavilion.dk/rooms/deluxe-2.jpg'],
    },
    {
      id: 2,
      code: 'JR-STE',
    ...
    },
    {
      ...
      bed: 'King',
      bedrooms: 2,
      description: "The crown jewel of the hotel — two bedrooms, a grand salon, private chef's kitchen, and rooftop terrace.",
      maxOccupants: 4,
      maxAdults: 4,
      childrenCapacity: 2,
      includedOccupancy: 2,
      facilities: ['Air conditioning', 'Full kitchen', 'Private terrace', 'Jacuzzi', 'Smart TV', 'Dedicated butler', 'Private dining room'],
      imageUrls: ['https://www.grandpavilion.dk/rooms/penthouse-1.jpg', 'https://www.grandpavilion.dk/rooms/penthouse-2.jpg'],
    },
  ],
...
(async () => {
  ...
  const outPath = join(__dirname, '..', 'sample-onboarding.pdf');
