...
import { OnboardingPDF } from '../api/pdf/OnboardingPDF';
  ...
  rooms: [
    {
      ...
      bedrooms: 1,
      description:
        'Elegantly appointed room with floor-to-ceiling windows and direct views over the Nyhavn canal.',
      maxOccupants: 2,
      maxAdults: 2,
      childrenCapacity: 1,
      includedOccupancy: 2,
    ...
    },
    {
      ...
      bedrooms: 1,
      description:
        'Expansive suite with a separate lounge, butler pantry, and private terrace overlooking the courtyard garden.',
      maxOccupants: 3,
      maxAdults: 2,
      childrenCapacity: 2,
      includedOccupancy: 2,
    ...
    },
    {
      ...
      bedrooms: 2,
      description:
        "The crown jewel of the hotel — two bedrooms, a grand salon, private chef's kitchen, and 270° rooftop terrace.",
      maxOccupants: 4,
      maxAdults: 4,
      childrenCapacity: 2,
      includedOccupancy: 2,
      ...
      imageUrls: [
        ...
        'https://www.grandpavilion.dk/rooms/penthouse-3.jpg',
      ],
    },
  ],
