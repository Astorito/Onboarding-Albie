...
interface Props {
  ...
  // (2+ products bought together).
  engagementSlug?: string | null;
}

export const ActivitiesSuccessStep = ({ engagementSlug }: Props) => {
  useEffect(() => {
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="font-body-lg text-on-surface-variant mb-10 max-w-xl mx-auto">
            Your activities setup has been submitted. Our team will review everything and get your
            booking engine ready to start taking reservations.
          </p>
