...
export const BankingSuccessStep = ({ engagementSlug }: Props) => {
  useEffect(() => {
    const end = Date.now() + 3 * 1000;
    const colors = ['#0D3A39', '#2F6B6D', '#F2EA5F'];
    (function frame() {
    ...
    <div className="h-full flex items-center justify-center px-margin-mobile bg-surface">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <h1 className="font-display-lg text-5xl text-primary mb-4">Thank you!</h1>
          <p className="font-body-lg text-on-surface-variant mb-10 max-w-xl mx-auto">
            Your banking information has been received securely. Our team will confirm once it's
          ...
          <div className="p-8 bg-surface-container-low border border-outline-variant rounded-3xl inline-block w-full text-left relative group">
            ...
            <p className="font-body-md text-on-surface mb-2">
              If you have any questions or need to make changes, please reach out:
            </p>
            <a
