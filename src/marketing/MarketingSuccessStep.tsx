...
interface Props {
  ...
  // (2+ products bought together) — see src/steps/SuccessStep.tsx for the
  // identical pattern used by the hotel flow.
  engagementSlug?: string | null;
}

export const MarketingSuccessStep = ({ engagementSlug }: Props) => {
  useEffect(() => {
