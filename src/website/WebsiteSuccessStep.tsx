...
export const WebsiteSuccessStep = ({ engagementSlug }: Props) => {
  useEffect(() => {
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="font-body-lg text-on-surface-variant mb-10 max-w-xl mx-auto">
            Your New Website Project onboarding answers have been collected. Our team will
            review them and reach out with next steps for your project.
          </p>
